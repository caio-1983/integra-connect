import type { ExtractedInfo, IncomingMessage, IntentClassification, IntentType, SentimentClassification, SentimentType } from '../types/index.js';

/**
 * Deterministic, keyword/regex-based classification — ported from the
 * frontend's `src/ai/services/nlpHeuristics.ts` (same logic, same agent).
...
export function countConsecutiveAgentReplies(messages: IncomingMessage[]): number {
